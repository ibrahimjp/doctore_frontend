...
const DoctorCard = ({ doctor, onBookNow }) => {
  return (
    <motion.div
      className="bg-gray-800 border border-gray-700 rounded-2xl overflow-hidden group transition-all duration-300 hover:border-green-500/50 hover:shadow-2xl hover:shadow-green-500/10"
  ...
  return (
    <div className="bg-black text-white min-h-screen pt-24 md:pt-20 p-20">
      <main className="main-container px-6">
        ...
        <motion.div 
          className="search-box bg-gray-800 border border-gray-700 p-4 rounded-2xl flex flex-col md:flex-row gap-4 max-w-4xl mx-auto mb-16"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <input
            type="text"
            className="w-full bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400"
            placeholder="Search by doctor's name..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
          />
          <select
            className="w-full md:w-64 bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-400"
